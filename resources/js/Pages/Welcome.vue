...
<template>
    <div class="relative overflow-hidden bg-gray-50 h-screen">
        ...
        <div class="relative pt-6 pb-16 sm:pb-24">
            ...
            <main class="mx-auto mt-16 max-w-7xl px-4 sm:mt-40 ">
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                        <span class="block xl:inline"></span>
                        {{ ' ' }}
                        <span class="block text-indigo-600 xl:inline">სესხი ადამიანებისგან ადამიანებისთვის</span>
                    </h1>
                    ...
                    <div class="mx-auto mt-5 max-w-md sm:flex sm:justify-center md:mt-8">
                        <div class="rounded-md shadow">
                            <a href="/login" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 md:py-4 md:px-10 md:text-lg">შესვლა</a>
                        </div>
                        <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                            <a href="/register" class="flex w-full items-center justify-center rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-indigo-600 hover:bg-gray-50 md:py-4 md:px-10 md:text-lg">რეგისტრაცია</a>
                        </div>
                    </div>
                </div>
            </main>
